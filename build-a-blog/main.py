...
class ViewPostHandler(webapp2.RequestHandler):
    def get(self, id):
        post_instance = Post.get_by_id(int(id)) #This grabs the post with all three of its attributes from the database: title, text_body, and created.

        content = '<h1>' + post_instance.title + '</h1>' + '<p>' + post_instance.text_body + '</p>'
